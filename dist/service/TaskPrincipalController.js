...
exports.TaskPrincipalController = void 0;
...
let TaskPrincipalController = class TaskPrincipalController {
    constructor(prisma) {
        this.prisma = prisma;
    }
    async createTask(taskDTO, res) {
        try {
            ...
            return res.status(common_1.HttpStatus.OK).json(tarefa);
        }
        catch (erro) {
            console.log(erro);
...
exports.TaskPrincipalController = TaskPrincipalController;
__decorate([
...
], TaskPrincipalController.prototype, "createTask", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], TaskPrincipalController.prototype, "deleteTask", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], TaskPrincipalController.prototype, "getTaskById", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], TaskPrincipalController.prototype, "getAllTask", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], TaskPrincipalController.prototype, "updateTask", null);
exports.TaskPrincipalController = TaskPrincipalController = __decorate([
    (0, common_1.Controller)('/task-principal'),
    __metadata("design:paramtypes", [prisma_conn_1.PrismaService])
], TaskPrincipalController);
//# sourceMappingURL=TaskPrincipalController.js.map